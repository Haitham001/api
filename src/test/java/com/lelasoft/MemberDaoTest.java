...
import com.lelasoft.dao.MemberDaoImpl;
...
public class MemberDaoTest
{
    ...
    public void testFindById()
    {
        ...
        Assert.assertEquals("John Smith", member.getUsername());
    ...
    public void testRegister()
    {
        ...
        Assert.assertEquals("Jane Doe", newMember.getUsername());
